...
const BusinessDetailsScreen = () => {
  ...
  const toggleBusinessTypeDropdown = () =>
    setShowBusinessTypeDropdown(prev => !prev);
  ...
  const handleNext = async () => {
    try {
      ...
      //   let url = 'http://192.168.69.48:5000/api/v1/' + 'register-business';

      //   const info = await axios.post(url, formData, {
      //     headers: HEADERS,
      //   });

      toast.show('Business details added successful', {
        type: 'success',
        placement: 'top',
        duration: 3000,
      });
          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.inputContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={toggleBusinessTypeDropdown}>
                <Text style={styles.dropdownText}>
                  {businessData.type || 'e.g. Restaurant'}
                </Text>
            ...
            <View style={styles.inputContainer}>
              ...
              <TouchableOpacity
                style={styles.dropdownButton}
                onPress={toggleAmenitiesDropdown}>
