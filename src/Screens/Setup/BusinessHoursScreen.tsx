...
import DownArrow from '../../assets/images/Setup/Right.svg';
...
const BusinessHoursScreen = () => {
  ...
  const [businessHours, setBusinessHours] = useState<BusinessHours>({
    ...
    Tuesday: {
      opening: new Date('2024-01-01T10:00:00'),
      closing: new Date('2024-01-01T17:00:00'),
    },
    Wednesday: {
      opening: new Date('2024-01-01T10:00:00'),
      closing: new Date('2024-01-01T17:00:00'),
  ...
  const [activeType, setActiveType] = useState<'opening' | 'closing' | null>(
    null,
  );
  ...
  const handleNext = async () => {
    // console.log(JSON.parse(businessHours));
    try {
      await AsyncStorage.setItem('hours', JSON.stringify(businessHours));
      toast.show('Business hours added successful', {
        type: 'success',
        placement: 'top',
        duration: 3000,
      });
            ...
            <View style={styles.timeContainer}>
              <TouchableOpacity
                ...
                <Text style={styles.amPmText}>
                  ...
                  <DownArrow width={10} height={10} style={styles.arrow} />{' '}
                  {/* Add arrow here */}
                </Text>
              </TouchableOpacity>
